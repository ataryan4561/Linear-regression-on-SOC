...
set ID 12
set hasByteEnable 0
set MemName linear_regressionbkb
...
set ID 13
set hasByteEnable 0
set MemName linear_regressioncud
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 194
...
set ID 14
set hasByteEnable 0
set MemName linear_regression_y
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 97
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 15 \
			corename linear_regression_AXILiteS_axilite \
			name linear_regression_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler linear_regression_AXILiteS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 8.75 \ 
    is_flushable 0 \ 
    name {linear_regression_gmem_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler linear_regression_gmem_m_axi
}
