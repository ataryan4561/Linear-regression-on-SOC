...
// ==============================================================
#ifndef __linear_regressioneOg__HH__
#define __linear_regressioneOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(linear_regressioneOg) {
    ...
    SC_CTOR(linear_regressioneOg):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
